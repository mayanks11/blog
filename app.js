...
mongoose.connect("mongodb+srv://admin:admin222@todo.dqrg5.mongodb.net/?retryWrites=true&w=majority").then(console.log("Database connected"));
    ...
    if(!err){
      foundPost.forEach(function(post){
        ...
        if(requestedTitle === storedTitle){
          // app.render("post", {title: post.title, content: post.body});
